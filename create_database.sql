...
VALUES ('Filip',
       ...
       ('Stanislaw',
        ...
        'I like haskell');
INSERT INTO users (firstname, lastname, username, email, password, salt, date_of_birth, info, options)
VALUES ('admin',
        'admin',
        'admin',
        'chips1331@gmail.com',
        'bc9475669c303acee340c55c73afc6e4cc70c48a55a6cbe328e3cf304901200ed16913686509fa0ac8e62e611f6b9e518e8ac07a1f7209435c8aaa4938107bd3',
        '5wHnCucxklBZ0LAVuMC1r1psLAye43XsxiSkZnBsYJL8uCUsVojtDyOfnZu3w6q2SebBlOF8eBBSTHeQnFMWkGoTXLszUaOOarrYFgKfaYWAwsoyt4hIqu6fqQgRS3c6',
        DATE('1970-01-01 00:00:01'),
        'I like trains', 11);
...
values (1, 3, 'siema', (NOW() - interval 1 DAY)),
...
insert into projects (title, description, created_date)
VALUES ('gra w kolko i krzyzyk', 'taka fajna gra', NOW()),
...
insert into users_countries (user_id, country_id)
VALUES (1, 1),
       (2, 2),
       (3, 3),
       (4, 4);
...
insert into posts (user_id, project_id, timestamp, text)
VALUES (1, 2, NOW(), 'lubie placki'),
...
insert into reports (user_id, post_id, reason, timestamp)
VALUES (1, 2, 'i dont like it', now()),
...
VALUES ('Java', 'Jezyk programowania'),
...
insert into users_technologies (technology_id, user_id)
VALUES (1, 2),
       (1, 1),
       (3, 2),
       (3, 1);
...
insert into projects_technologies (technology_id, project_id)
VALUES (1, 2),
       (1, 1),
       (3, 2),
       (3, 1);